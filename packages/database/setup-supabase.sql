-- RiceMillOS Database Setup for Supabase
...
-- RLS Policies for Products (global products)
...
-- RLS Policies for Paddy Intakes
...
-- RLS Policies for Inventory Stock
...
-- Success message
SELECT 'RiceMillOS database setup completed successfully! 🎉' as message;